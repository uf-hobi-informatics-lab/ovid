...
try:
    ...
    fixed_df = examined_table.withColumn(field_to_examine_name,when(col(field_to_examine_name).isNull(), col(field_to_copy_name)).otherwise(col(field_to_examine_name))
)

    bad_rows = examined_table.filter(examined_table[field_to_examine_name].isNull())                                                                                        
