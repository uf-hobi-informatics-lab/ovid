...
spark = cf.get_spark_session("delete_when_null")

this_fix_name = 'custom_delete_when_null_fix_1.0'
...
try:
    ...
    good_rows = examined_table.filter(examined_table[field_to_examine_name].isNotNull())                                                                                        
